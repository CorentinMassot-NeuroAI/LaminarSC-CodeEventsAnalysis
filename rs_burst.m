function [archive_burst_RS,archive_burst_length,archive_burst_start]=rs_burst(tn)
%function [archive_burst_RS,archive_burst_length,archive_burst_start]=rs_burst(tn,RSalpha,limit)
